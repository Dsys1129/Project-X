package com.duodome13.explorationLog.service;


import com.duodome13.explorationLog.ExplorationLog;
import com.duodome13.explorationLog.controller.ExplorationLogRequestDTO;
import com.duodome13.explorationLog.controller.ExplorationLogResponseDTO;
import com.duodome13.explorationLog.controller.ExplorationLogUpdateRequestDTO;
import com.duodome13.explorationLog.repository.ExplorationLogRepository;
import com.duodome13.global.exception.custom.AuthorizationException;
import com.duodome13.global.exception.custom.ExplorationLogNotFoundException;
...
public class ExplorationLogService {
    ...
    public ExplorationLogResponseDTO findExplorationLog(Long id) {
        ExplorationLog findExplorationLog = explorationLogRepository.findById(id)
                .orElseThrow(() -> new ExplorationLogNotFoundException("해당하는 탐사일지가 없습니다."));
